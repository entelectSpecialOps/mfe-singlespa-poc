      ...
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        <div class="-mr-2 -my-2 md:hidden">
         ...
         <nuxt-link to="/">
            ...
            <img class="h-24 w-auto transition duration-500 scale-90 hover:scale-110" src="/img/logo.png"/>
          </nuxt-link>

        <nav v-if="user" class="hidden md:flex space-x-10">
          ...
          <nuxt-link to="/angularApp">
            <span class="text-base font-medium text-gray-500 hover:text-gray-900">
              Angular App
            </span>
          </nuxt-link>
          <nuxt-link to="/reactApp">
            <span class="text-base font-medium text-gray-500 hover:text-gray-900">
              React App
            </span>
          </nuxt-link>
